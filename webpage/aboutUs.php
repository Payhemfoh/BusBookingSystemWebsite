...
<html lang="en">
    ...
    <head>
        <title>Speedy Bus | About Us</title>
    ...
    <body id="main">
        ...
        <div id="content">
            <h3>Who are we?</h3>
            <p>Founded in 2008, Speedy Bus Booking Website was born as a one-stop platform that sells bus tickets in Malaysia.
               We’ve grown rapidly and are now the largest online booking platform in Southeast Asia with more than 5 Million tickets sold online.</p>
            <br><br>
